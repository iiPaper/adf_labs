...
('Whiskers', 'Cat', 'Persian', 5, 'A94B6F3'),
('Coco', 'Rabbit', 'Holland Lop', 1, 'C15DE67'),
('Goldie', 'Fish', 'Goldfish', 1, 'T12AB34'),
('Polly', 'Bird', 'Parakeet', 2, 'F12GH89'),
('Max', 'Dog', 'German Shepherd', 5, 'B78IJ01'),
('Luna', 'Cat', 'Maine Coon', 3, 'D02XY45'),
('Nibbles', 'Hamster', 'Syrian Hamster', 1, 'D02XY45');